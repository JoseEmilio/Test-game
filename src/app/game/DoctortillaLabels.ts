...
export const DOCTORTILLA_LABELS: ILabels = {
    'es': {
        ...
        'NOT_SO_NEEDY': 'No he llegado al punto de rebuscar en la basura, estoy a dos entrevistas aún.',
        ...
        'YOU_ALREADY_THROW_TO_WC': '¿No has tenido suficiente con tirarlo al retrete?.',
        'EVERYTHING_IS_TRUE_BUT': 'Todo lo que pone aquí es cierto salvo alguna cosa.',

        // WC
        'SINK': 'lavabo',
        'MODERN_SINK': 'Un lavabo moderno, hecho entero de metal.',
        'SAVE_WATER': 'No malgastes agua hombre, es un bien escaso.',
        'WC': 'váter',
        'I_COULD_USE_THEN_DAILY': 'Están decentes. Podría usarlos a diario y cobrar por ese tiempo.',
        'RATHER_BE_ALONE': 'Preferiría estar a solas para eso.',
        'THROW_CV_TO_WC': 'NOOOOOO...',
        'MORE_COPIES': 'menos mal que tengo más copias.',
        ...
        'TOILER_PAPER_LOCKED_UP': 'Papel higiénico bajo llave, el fracaso de la civilización.',
        'OK_ALWAYS_USEFUL': 'Vale, siempre viene bien.',
        'ALWAYS_USEFUL': 'Siempre viene bien.',
        'DONT_THROW_PAPER': 'AVISO: no tirar toallitas ni papeles al retrete...',
        'CAN_GET_STUCK': 'puede atrancarse y provocar un desastre higiénico.',
        'TOILET_PAPER': 'papel del culo',
        'ITS_GONNA_GET_STUCK': 'Al final se acabará atascando.',
        'PAPER_IS_TOO_THIN': 'El papel es demasiado fino, hace bola pero aún cuela. Necesita algo más consistente.',
        'STUCK_WC': 'váter atascado',
    ...
    'en': {
        ...
        'NOT_SO_NEEDY': 'I\'m not so needy, just a couple of work interviews from that.',
        ...
        'YOU_ALREADY_THROW_TO_WC': 'You\'ve already thrown it to the toilet, aren\'t you happy enough with it?',
        'EVERYTHING_IS_TRUE_BUT': 'Everything in this document is true except some small things.',       
        
        // WC
        'SINK': 'sink',
        'MODERN_SINK': 'A full metal modern sink.',
        'SAVE_WATER': 'Don\'t waste water my friend.',
        'WC': 'wc',
        'I_COULD_USE_THEN_DAILY': 'It\'s quite clean. I could use then daily and get paid for it.',
        'RATHER_BE_ALONE': 'I\'d rather be alone for that.',
        'THROW_CV_TO_WC': 'NOOOOOO...',
        'MORE_COPIES': 'lucky I\'ve more copies.',
        ...
        'ITS_GONNA_GET_STUCK': 'It\'s gonna get stuck!.',
        'PAPER_IS_TOO_THIN': 'Toilet paper is too thin, it needs something more consistent.',
        'ITS_STUCK': 'It\'s stuck!',
